...
function useAPIKeys(params) {
  ...
  return usePagesOrInfinite({
    fetcher: clerk.apiKeys?.getAll ? (params2) => clerk.apiKeys.getAll({
      ...params2,
...
// node_modules/@clerk/shared/dist/_chunks/utils-V2FbmPWk.mjs
...
var isThatComponent = (v, component) => {
  return !!v && import_react3.default.isValidElement(v) && v?.type === component;
};
...
var CustomPortalsRenderer = (props) => {
  return import_react3.default.createElement(import_react3.default.Fragment, null, props?.customPagesPortals?.map(({ key, portal }) => (0, import_react3.createElement)(portal, { key })), props?.customMenuItemsPortals?.map(({ key, portal }) => (0, import_react3.createElement)(portal, { key })));
};
...
// node_modules/@clerk/react/dist/ClerkProvider-BWj89qiw.mjs
...
var versionSelector = (clerkJSVersion, packageVersion = "6.29.1") => {
...
var clerkUIScriptUrl = (opts) => {
  ...
  const version2 = versionSelector(__internal_clerkUIVersion, "1.30.3");
